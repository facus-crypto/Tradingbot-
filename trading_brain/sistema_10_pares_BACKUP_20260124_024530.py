        ...
        try:
            ...
            if señal:
                if señal['direccion'] != "NEUTRAL":
                    ...
                    # ===== BACKTESTING OPCIONAL (DESACTIVADO TEMPORALMENTE) =====
                    # Para activar: quitar el comentario de las siguientes líneas
                    # try:
                    ...
                    #     print(f"   📊 Backtesting: {resultado}")
                    # except ImportError:
                    #     print(f"   ⚠️  Módulo backtester no disponible")
                    # ===== FIN BACKTESTING =====
                    
                    # Validar con sistema actual (que SÍ funciona)
