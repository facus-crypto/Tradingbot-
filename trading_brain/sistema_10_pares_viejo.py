#!/usr/bin/env python3
"""
SISTEMA 10 PARES OPERATIVOS - Monitorea TODOS los cerebros
"""
import sys
import json
import logging
...
print(f"\n🔍 MONITOREO COMPLETO - 10 PARES")
print("   BTC, ETH, SOL, LINK, BNB, ADA, AVAX, XRP, DOT, ATOM")
        ...
        if señal:
            if señal['direccion'] != "NEUTRAL":
                ...
                if validacion['valida']:
                    ...
                    # Enviar a Telegram
                    enviado = cerebro.enviar_senal_con_validacion(señal)
                    if enviado:
...
# ===== ACTUALIZAR ESTADÍSTICAS AL FINAL DE CADA CICLO =====
actualizar_estadisticas(señales_encontradas)
while True:
    print("\n" + "="*70)
    print("⏳ Esperando 5 minutos para próximo análisis...")
    print("="*70)
