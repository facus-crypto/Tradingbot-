#!/usr/bin/env python3
"""
Bot de Telegram para comando /status - FORMATO SIMPLE Y CLARO
"""
import json
import logging
...
async def status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Maneja el comando /status - LISTA VERTICAL SIMPLE"""
    try:
        # Cargar estadísticas
        try:
        ...
        # Obtener precios en LISTA VERTICAL SIMPLE
