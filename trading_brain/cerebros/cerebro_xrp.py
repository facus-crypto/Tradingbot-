...
class CerebroXRP(CerebroFuturesBase):
    def __init__(self, binance_manager=None, telegram_bot=None):
        ...
        logger.info(f"🧠 Cerebro $(echo XRP) inicializado - {self.estrategia}")
...
cerebro = CerebroXRP(binance_manager=None, telegram_bot=None)
