...
class CerebroAVAX(CerebroFuturesBase):
    def __init__(self, binance_manager=None, telegram_bot=None):
        self.simbolo = "AVAXUSDT"
        ...
        logger.info(f"🧠 Cerebro $(echo AVAX) inicializado - {self.estrategia}")
...
cerebro = CerebroAVAX(binance_manager=None, telegram_bot=None)
