...
class CerebroDOT(CerebroFuturesBase):
    def __init__(self, binance_manager=None, telegram_bot=None):
        ...
        logger.info(f"🧠 Cerebro $(echo DOT) inicializado - {self.estrategia}")
...
cerebro = CerebroDOT(binance_manager=None, telegram_bot=None)
