...
with open('cerebros/cerebro_sol.py', 'w') as f:
    f.write(sol_original)

print("✅ cerebro_sol.py RESTAURADO a versión original que SÍ funcionaba")
