...
class CerebroETH(CerebroFuturesBase):
    def __init__(self, binance_manager=None, telegram_bot=None):
        ...
        self.config = {
            "combinacion": "macd_bollinger_obv",
            "timeframe_analisis": "15m"
        }
        self.estrategia = "MACD Bollinger OBV"
        self.senal_actual = None
        self.ultimo_analisis = None
        logger.info(f"🧠 Cerebro ETH inicializado - {self.estrategia}")
...
cerebro = CerebroETH(binance_manager=None, telegram_bot=None)
