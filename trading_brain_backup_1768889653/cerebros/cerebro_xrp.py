...
class CerebroXRPFutures(CerebroFuturesBase):
    ...
    def generar_senal(self, df):
        ...
        # Detectar squeeze y expansión
        squeeze_actual = ultimo["BB_width"] < 0.03
        squeeze_anterior = penultimo["BB_width"] < 0.03
        # Expansión: las bandas se están abriendo
        expansion = ultimo["BB_width"] > penultimo["BB_width"] * 1.1
        ...
        if squeeze_anterior and expansion and volumen_alto:
    ...
    def calcular_sl_tp_trailing(self, precio_entrada, precio_actual, ganancia_actual=None):
        """
        Calcula trailing stop para XRP/USDT con tres fases CORREGIDO
        ...
        2. TRAILING: Ganancia entre 1% y 7% (excluyendo ambos extremos)
